                ...
                <tr>
                    <td class="body" width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                               style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                            <!-- Body content -->
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h2 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 16px; font-weight: bold; margin-top: 0; text-align: center;margin: 5rem 0;">
                                        您好，这里是 <a style="color: #2F3133;text-decoration: none;" href="{{ url('/') }}">Hesunfly Blog</a>，感谢您订阅我的博客！我刚刚发布了一篇新文章，快来看看吧！</h2>
                                    <pre style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;text-align: center;margin: 5rem 0;"><code style="font-size: 20px;font-weight: bold;text-align: center;"><a style="color: #2F3133;text-decoration: none;" href="{{ url('/articles/' . $article->slug) }}">{{ "<< " . $article->title . " >>" }}</a></code></pre>
